...
// Currently just a copy of ManualTest4.... TODO: use only JUnit3 elements
public class ManualTest3 {

	static JUnitCore core = new JUnitCore();
	static int totalRunCount = 0;
	static int totalFailureCount = 0;
	static ClassLoader classLoader = ManualTest3.class.getClassLoader();;

	public static void main(String[] args) {

		runTest("TriangleClassifierTest3");
